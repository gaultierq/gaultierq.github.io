...
<!-- Start: Post Type Gallery -->
<article id="post-<?php the_ID(); ?>" <?php post_class('basic-post post-picture post-picture-slider'); ?>>
	<div class="post-slider">
		<?php
		if( has_shortcode( get_the_content(), 'gallery' ) ) {
			preg_match_all( '#\[gallery\s*.*?\]#s', get_the_content(), $galleries );
			echo apply_filters('the_content', $galleries[0][0]);
		}
		?>
	</div>
