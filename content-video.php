...
<article id="post-<?php the_ID(); ?>" <?php post_class('basic-post post-video'); ?>>
	<div class="thumbnail video-holder">
		<?php
		// Get external status
		if( function_exists('get_field') ) {
			echo '<div class="embed-player">' . apply_filters('the_content', esc_url( get_field('format_video_embed') ) ) . '</div>';
		}
		?>
	</div>
